...
session_start();
$user_sql = mysqli_query($conn, "SELECT * FROM users WHERE id='" . $_SESSION['id'] . "'  ");
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link text-dark font-weight-bold" href="home.php"><img src="user/<?php echo $user['photo'] ?>" class="rounded-circle mr-1" width="30px;" height="30px;"><?php echo $user['name'] ?></a>
        </li>
        <li class="nav-item">
